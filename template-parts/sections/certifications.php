    ...
    <div class="cert-section-overlay absolute top-0 left-0 w-full h-full bg-[rgba(0,0,0,0.7)] text-secondary hidden justify-center items-center opacity-0 transition-opacity duration-300 shadow-sm">
        ...
        <div class="p-10 h-1/2 w-[90%] bg-[#f9f9f9] flex flex-col justify-center items-center relative bg-certification-bg">
            ...
            <div class="relative z-10">
                <button class="close-overlay absolute top-[10px] right-[10px] bg-[#f9f9f9] border-none py-[10px] px-[15px] rounded-[5px] cursor-pointer transition-colors duration-300">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/close2.png" alt="close" class="absolute top-[10px] right-[10px] w-[30px] h-[30px] cursor-pointer transition-transform duration-300">
                </button>
                <h3 class="overlay-title text-2xl mb-5 animate-fade-in-down text-center font-bold"></h3>
                <p class="overlay-description text-lg leading-[1.6] text-left"></p>
