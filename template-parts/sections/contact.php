        ...
        <div class="contact-options">
            <div class="contact-option" data-option="booking">
                <div class="contact-circle" style="background-color: #fd8e8e;">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-working.png" alt="Booking" class="contact-icon">
                </div>
            ...
            <div class="contact-option" data-option="quote">
                <div class="contact-circle" style="background-color: #fde58e;">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-money.png" alt="Quote" class="contact-icon">
                </div>
            ...
            <div class="contact-option" data-option="hello">
                <div class="contact-circle" style="background-color: #8efdb0;">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-wave.png" alt="Hello" class="contact-icon">
                </div>
